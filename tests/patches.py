...
patch_cmd_start_learn = make_patch_by_path("handlers.scenario_learn.cmd_start")
patch_learn_callback = make_patch_by_path("handlers.scenario_learn.learn_callback")
